...
const Post = ({img, username, userImg, caption, id}) => {
  ...
  return (
    <> 
         ...
         <div className='flex items-center p-5'>
               <img src={userImg} alt="" className='rounded-full h-12 w-12 object-contain border m-3 p-1'  />
  ...
  {session && (
    <div className='flex justify-between px-4 pt-4'>
        ...
        {
          hasLiked ? (
            <HeartIconFilled onClick={likePost} className="iconbtn text-red-500"/>
          ) : (
